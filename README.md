...
- стартовые проекты импортированы из Obsidian vault `C:\Users\ksntired\Downloads\ksntired_work`: описания, семантика, контент-планы, закупка ссылок и документы.

## Данные из Obsidian

Встроены 7 проектов из папки `Проекты`: `1-pa.ru`, `1plab.ru`, `Good Food`, `avetdigital.ru`, `dr-prof.ru`, `sdoplatforma.ru`, `Вечная память`. Если в браузере уже были сохранены старые данные, новые seed-проекты добавятся автоматически при открытии страницы. Кнопка `Сброс` очищает локальные изменения и снова показывает стартовую базу из Obsidian.
